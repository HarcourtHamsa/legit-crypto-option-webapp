...
function Faq() {
  return (
    <Box bg="white">
      <Head>
        <title>FAQs - Expert Hub Trade</title>
        ...
        >
          ...
          <Accordion>
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                Expert Hub Trades generates profit by trading in Top 10 crypto
                currencies. It’s AI trading bot generates profit via arbitrage
                trading.
              </AccordionPanel>
            </AccordionItem>
