...
export default function Testimonials() {
  return (
    <Container maxW={{ md: "80%", base: "90%" }} mb={36}>
      <Flex
        textAlign={"center"}
        pt={10}
      ...
      >
        <Box width={{ base: "full", sm: "lg", lg: "xl" }} margin={"auto"}>
          ...
          <Heading
            ...
            py={6}
          >
            <Text> You&apos;re in good company</Text>
          </Heading>
          <chakra.h2
            margin={"auto"}
            width={"70%"}
